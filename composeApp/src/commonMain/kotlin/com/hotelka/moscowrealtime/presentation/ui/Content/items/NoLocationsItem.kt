...
import moscowrealtime.composeapp.generated.resources.no_locations_included
...
fun NoLocationsItem() {
    Row(
        ...
        Text(
            stringResource(Res.string.no_locations_included),
            fontSize = 14.sp,
            fontWeight = FontWeight.SemiBold,
            color = secondaryTextColor.copy(0.8f)
        )
    }
}